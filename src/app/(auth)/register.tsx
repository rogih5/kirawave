...
export default function RegisterScreen() {
    ...
    const handleRegister = async () => {
        ...
        // Simulação de registro (Bypass Firebase)
        setTimeout(() => {
            setUser({
        ...
        >
            ...
            <ScrollView contentContainerStyle={s.inner} showsVerticalScrollIndicator={false}>
                ...
                <View style={s.logoArea}>
                    ...
                    <Text style={s.tagline}>Comece sua jornada de foco</Text>
                </View>
                ...
                <View style={s.card}>
                    ...
                    >
                        ...
                        >
                            {loading
                                ...
                                : <Text style={s.btnPrimaryTx}>Cadastrar Agora</Text>
                            }
                        </LinearGradient>
                    </TouchableOpacity>
                    ...
                    <Link href={'/(auth)/login' as any} asChild>
                        <TouchableOpacity style={s.linkBtn}>
                            <Text style={s.linkTx}>
                                Já tem uma conta? <Text style={s.linkHighlight}>Entrar</Text>
                            </Text>
                        </TouchableOpacity>
                    </Link>
                </View>
